...
storiesOf('Icons', module)
  .add(
    ...
    () => {
      return (
        <div className="indigo-layout-grid">
          ...
          <div>
            <Icon.TransformationAlt />
          </div>
          <div>
            <Icon.Transformation />
          </div>
          <div>
            <Icon.TransformationOverview />
          </div>
          <div>
            <Icon.Trash />
          </div>
    ...
    {
      info: {
        text: `Set of Keboola SVG icons. Color can be changed by css 'color' property. When adding new icons to src/icons, you need to re-run svg compilation.`,
      },
    }
  )
  .add(
