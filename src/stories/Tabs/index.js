            ...
            <Tabs defaultActiveKey={2} id="uncontrolled-tab-example">
                ...
                ></span></span></a>}>
                    <div id="components-migration-row-tabs-pane-general"
                         aria-labelledby="components-migration-row-tabs-tab-general" role="tabpanel" aria-hidden="false"
                         className="tab-pane active">
                        <div className="table-responsive">
                ...
                <Tab eventKey={2} title={<a id="components-migration-row-tabs-tab-datasample" role="tab"
                                            aria-controls="components-migration-row-tabs-pane-datasample" tabindex="-1"
            ...
            <div className="kbc-inner-content-padding-fix with-bottom-border">
                <Tabs defaultActiveKey={2} id="uncontrolled-tab-example">
                    <Tab eventKey={1} title="General">
                        <div id="modules-ex-s3-react-pages-index-index-tabbed-area-pane-1"
                             aria-labelledby="modules-ex-s3-react-pages-index-index-tabbed-area-tab-1" role="tabpanel"
                             aria-hidden="true" className="tab-pane">
                            <div className="form-horizontal">
                                <div className="form-group"><label
                    ...
                    <Tab eventKey={2} title="AWS Credentials">
                        <div id="modules-ex-s3-react-pages-index-index-tabbed-area-pane-2"
                             aria-labelledby="modules-ex-s3-react-pages-index-index-tabbed-area-tab-2" role="tabpanel"
                             aria-hidden="true" className="tab-pane">
                            <div className="form-horizontal">
                                <div className="form-group"><label
                    ...
                    <Tab eventKey={3} title="Advanced" disabled>
                        <div id="modules-ex-s3-react-pages-index-index-tabbed-area-pane-3"
                             aria-labelledby="modules-ex-s3-react-pages-index-index-tabbed-area-tab-3" role="tabpanel"
                             aria-hidden="false" className="tab-pane active">
                            <div className="form-horizontal">
                                <div className="form-group"><label
                                    className="col-xs-4 control-label"
    ...
    .add('Tabs @ Apify (TabbedWizard)', () => (
        ...
        <div className="static-modal" style={{position: 'relative'}}>
            <Modal.Dialog className="kbc-wrapper-tabs-margin-fix">
                ...
                <Modal.Body>
                    <Tabs defaultActiveKey={2} id="uncontrolled-tab-example">
                        <Tab eventKey={1} title="Action">
                            <div id="controlled-tab-wizard-pane-1" aria-labelledby="controlled-tab-wizard-tab-1"
                                 role="tabpanel" aria-hidden="false" className="tab-pane active"
                            >
                        ...
                        <Tab eventKey={2} title="Authentication">
                            <div id="controlled-tab-wizard-pane-2" aria-labelledby="controlled-tab-wizard-tab-2"
                                 role="tabpanel" aria-hidden="true" className="tab-pane"
                            >
                                <div className="row form-horizontal clearfix">
                                    <div className="form-group"><label
                                        ...
                                        <div className="col-xs-10"><input
                                            placeholder="Enter User ID" type="text" value="" className="form-control"
                                        /><span className="help-block"
                                        ><span
                                        ><span
                        ...
                        <Tab eventKey={3} title="Specification">
                            <div id="controlled-tab-wizard-pane-3" aria-labelledby="controlled-tab-wizard-tab-3"
                                 role="tabpanel" aria-hidden="false" className="tab-pane active">
                                <div className="row form form-horizontal">
                                    <div className="form-group has-error">
                                        ...
                                        <div className="col-xs-8"><p
                                            ...
                                            title="Refresh" className="kbc-refresh kbc-icon-cw"></span></span></span>
                                        </p></div>
                                    </div>
                                    <div className="form-group">
                                                            ...
                                                            <div style={{position: 'relative', top: 0}}>
                                                                <div className="CodeMirror-lines">
                                                                    <div
                                                                        ...
                                                                        <div className="CodeMirror-measure">AخA</div>
                ...
                <Modal.Body>
                    ...
                    <Tabs defaultActiveKey={2} id="uncontrolled-tab-example">
                        <Tab eventKey={1} title="Relative">
                            <div id="daterangemodaltab-pane-relative" aria-labelledby="daterangemodaltab-tab-relative"
                                 role="tabpanel" aria-hidden="false" className="tab-pane active"
                            >
                        ...
                        <Tab eventKey={2} title="Tab 2">
                            <div id="daterangemodaltab-pane-absolute" aria-labelledby="daterangemodaltab-tab-absolute"
                                 role="tabpanel" aria-hidden="true" className="tab-pane">
        ...
        <div className="static-modal" style={{position: 'relative'}}>
            <Modal.Dialog className="kbc-wrapper-tabs-margin-fix">
                ...
                <Modal.Body>
                    ...
                    <Tabs defaultActiveKey={2} id="uncontrolled-tab-example">
                        <Tab eventKey={1} title="General">
                            <div id="ex-facebook-query-modal-tabs-pane-1"
                                 aria-labelledby="ex-facebook-query-modal-tabs-tab-1" role="tabpanel"
                                 aria-hidden="false" className="tab-pane active">
                                <div className="row form-horizontal clearfix">
                                    <div className="form-group">
                                        ...
                                        <div className="col-xs-10">
                                            ...
                                            />
                                                ...
                                                ><div
                                                    className="Select-value"
                                                ><span
                                                    className="Select-value-label" role="option" aria-selected="true"
                                                    id="react-select-5--value-item"
                                                >All Pages</span></div><div
                                                    className="Select-input" style={{display: 'inline-block'}}
                                                ><input
                                                    role="combobox" aria-expanded="false" aria-owns=""
                                                    aria-haspopup="false" aria-activedescendant="react-select-5--value"
                                                    value="" style={{width: 5, boxSizing: 'content-box'}}
                                                /><div
                                                    style={{
                                                        position: 'absolute',
                        ...
                        <Tab eventKey={2} title="Advanced">
                            <div id="ex-facebook-query-modal-tabs-pane-2"
                                 aria-labelledby="ex-facebook-query-modal-tabs-tab-2" role="tabpanel" aria-hidden="true"
                                 className="tab-pane">
                                <div className="row form-horizontal clearfix">
                                    <div className="form-group">
                                        <div className="col-md-12"><span
                                    ...
                                    >Since</label>
                                        <div className="col-xs-10"><input
                                            placeholder="yyyy-mm-dd or 15 days ago" type="text" className="form-control"
                                        /><span className="help-block"
