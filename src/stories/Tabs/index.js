...
storiesOf('Tabs')
    .addWithInfo(
        'KBC - Tabs @ Token access',
        'Desc',
        () => (
            <div className="ng-isolate-scope">
                <ul className="nav nav-tabs" ng-className="{'nav-stacked': vertical, 'nav-justified': justified}"
                    ng-transclude="">
                    <li ng-className="{active: active, disabled: disabled}" heading="Overview"
                        className="ng-isolate-scope active">
                    ...
                    <li ng-className="{active: active, disabled: disabled}" className="ng-isolate-scope">
                        <a ng-click="select()" tab-heading-transclude="" className="ng-binding">
                            <tab-heading className="ng-scope">
                                Events
                                <a kb-loader="" className="kb-loader ng-scope" tooltip="" title="Refresh events"
                                   is-loading="events.newEventsLoading" ng-click="events.refresh()">
                    ...
                    <li dropdown="" ng-hide="token.isMasterToken" className="ng-scope">
                        <a href="#" dropdown-toggle="" aria-haspopup="true" aria-expanded="false">Actions <span
                            className="caret"></span></a>

                        <ul className="dropdown-menu">
                            <li>
                                <a href="javascript:void(0)" kb-confirm=""
                                   message="Do you really want to delete token wrdbsnowflake_253101738?"
                                   confirm-type="danger" confirm-label="Delete" on-confirm="delete()"
                                   header="Delete token">
                ...
                <div className="tab-content">
                    <div className="tab-pane ng-scope active" ng-repeat="tab in tabs"
                         ng-className="{active: tab.active}" tab-content-transclude="tab">

                        111

                    </div>
                    <div className="tab-pane ng-scope" ng-repeat="tab in tabs" ng-className="{active: tab.active}"
                    ...
                    <div className="container">
                        ...
                        <ul className="nav navbar-nav">
                            ...
                            <li ng-repeat="page in mainNavigationPages"
                                ng-className="{'active': isMainNavigationPageActive(page.id)}"
                                className="ng-scope active">
        ...
        () => (
            <div >
                <ul role="tablist" className="nav nav-tabs">
                    <li role="presentation" className="active"><a role="tab" aria-selected="true"
                                                                  href="#">Authorization</a>
                    </li>
                ...
                <div className="tab-content">
                        ...
                        <div className="kbc-row clearfix">
                            <div className="pull-right">
                                <div ><span >&nbsp; &nbsp;</span><a ><span
                                    className="kbc-icon-cup fa fa-fw"></span><span > Move to Trash</span></a>
                    ...
                    <div step="followers" role="tabpanel" aria-hidden="true" className="tab-pane">
                        <div className="row">
                            <div className="col-md-8">
                                <div className="form-group"><label className="control-label">Screen name</label>
                                    <div ><input value="" label="Screen name" type="text"
