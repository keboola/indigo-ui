...
storiesOf('[CSS] Tabs', module)
  .add(
    ...
    { info: { text: 'Basic usage of tabs with custom styles' } }
  )
  .add(
    ...
    {
      info: {
        text: `Serves for table content inside Tab. Add '.tab-pane-no-padding' on <Tab> element. So you can remove padding per tab.`,
      },
    }
  )
  .add(
              ...
              <Modal.Body>
                <Tabs id="modal-with-tabs" className="tabs-inside-modal" defaultActiveKey={1}>
                  <Tab eventKey={1} title="Tab 1">
                    ...
                    excepturi neque quisquam ratione tempore!
                  </Tab>
                  <Tab eventKey={2} title="Tab 1">
                    Ab aliquam architecto eos et laboriosam libero molestiae qui quisquam rerum
                    vero. Accusamus, quibusdam, voluptates.
                  </Tab>
                </Tabs>
              </Modal.Body>
            </Modal.Dialog>
    ...
    {
      info: {
        text: `Serves for Tabs used inside in modal. Adjusts spacing to fit Tabs. Add '.tabs-inside-modal' on <Tabs> element.`,
      },
    }
  );
