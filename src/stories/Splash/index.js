...
let descriptionContent = (
  <div className="splash-description-container">
    <div className="splash-description splash-description-1">
      ...
      <ExternalLink href="https://goo.gl/maps/VJjhZ5tVBU52" className="splash-link">
    ...
    <div className="splash-description splash-description-2">
      ...
      <ExternalLink href="https://goo.gl/maps/rxLPXWRZqPF2" className="splash-link">
    ...
    <div className="splash-description splash-description-3">
      ...
      <ExternalLink href="https://goo.gl/maps/VCfkdJy4xCu" className="splash-link">
    ...
    <div className="splash-description splash-description-4">
      ...
      <ExternalLink href="https://goo.gl/maps/4KjQP4hUe9q" className="splash-link">
        Offsite kart race
      </ExternalLink>
    </div>
    <div className="splash-description splash-description-5">
      ...
      <ExternalLink href="https://goo.gl/maps/H96ghnFWkaU2" className="splash-link">
    ...
    <div className="splash-description splash-description-6">
      ...
      <ExternalLink href="https://goo.gl/maps/ngAp7ijJyj62" className="splash-link">
    ...
    <div className="splash-description splash-description-7">
      ...
      <ExternalLink href="https://goo.gl/maps/CVpnCscDjRs" className="splash-link">
    ...
    <div className="splash-description splash-description-8">
      ...
      <ExternalLink href="https://goo.gl/maps/aFfwvCtmNvk" className="splash-link">
        Lago di Lesina
      </ExternalLink>
    </div>
  </div>
